...
const Modal = ({ isOpen, onClose, title, children, maxWidth = 'max-w-md' }) => {
  ...
  return (
    <div className={`fixed inset-0 z-50 flex items-center justify-center p-4 overscroll-contain bg-black/60 backdrop-blur-sm transition-opacity duration-200 ${isOpen ? "opacity-100" : "opacity-0"}`}>
      <div
